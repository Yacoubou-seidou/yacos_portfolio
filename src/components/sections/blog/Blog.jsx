                ...
                <div className="blog-card">
                  <div className="media-block">
                    ...
                    <a href="blog-post-1.html">
                      <img src="img/blog/blog_post_1.jpg" className="size-blog-masonry-image-two-c"
              ...
              <div className="item post-2">
                <div className="blog-card">
                  <div className="media-block">
                    ...
                    <a href="blog-post-1.html">
                      <img src="img/blog/blog_post_2.jpg" className="size-blog-masonry-image-two-c"
              ...
              <div className="item post-1">
                <div className="blog-card">
                  <div className="media-block">
                    ...
                    <a href="blog-post-1.html">
                      <img src="img/blog/blog_post_3.jpg" className="size-blog-masonry-image-two-c"
              ...
              <div className="item post-2">
                <div className="blog-card">
                  <div className="media-block">
                    ...
                    <a href="blog-post-1.html">
                      <img src="img/blog/blog_post_4.jpg" className="size-blog-masonry-image-two-c"
